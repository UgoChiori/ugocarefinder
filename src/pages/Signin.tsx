...
//         <h1 className="login_form_title">Sign In To Your Account</h1>
//         <p>Find Hospitals and Doctors near you. Share with friends and family.</p>
      ...
      <div className="login-form">
        ...
        {loggedIn ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button className="login-methods" type="submit">
              Login
            </button>
          </form>
        )}
